...
global.owner = process.env.OWNER_NUMBER  || '94774867500' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=DJMXmTwS#KnBvEXH8s87_EfA1GZypswoyU-z2gp5sKpodSuvPaaI' ,
